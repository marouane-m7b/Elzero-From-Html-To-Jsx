            ...
            <div className="content w-full">
                ...
                <div className="courses-page d-grid m-20 gap-20">
                    <div className="course bg-white rad-6 p-relative">
                        <img className="cover" src="imgs/course-01.jpg" alt="" />
                        <img className="instructor" src="imgs/team-01.png" alt="" />
                        <div className="p-20">
                    ...
                    <div className="course bg-white rad-6 p-relative">
                        <img className="cover" src="imgs/course-02.jpg" alt="" />
                        <img className="instructor" src="imgs/team-02.png" alt="" />
                        <div className="p-20">
                    ...
                    <div className="course bg-white rad-6 p-relative">
                        <img className="cover" src="imgs/course-03.jpg" alt="" />
                        <img className="instructor" src="imgs/team-01.png" alt="" />
                        <div className="p-20">
                    ...
                    <div className="course bg-white rad-6 p-relative">
                        <img className="cover" src="imgs/course-04.jpg" alt="" />
                        <img className="instructor" src="imgs/team-03.png" alt="" />
                        <div className="p-20">
                    ...
                    <div className="course bg-white rad-6 p-relative">
                        <img className="cover" src="imgs/course-05.jpg" alt="" />
                        <img className="instructor" src="imgs/team-03.png" alt="" />
                        <div className="p-20">
